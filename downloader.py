    ...
    try:
        ...
        if latest_version:
            if latest_version > CURRENT_VERSION:
                ...
                print(f"\nYou are already using the latest version ({CURRENT_VERSION}). No update needed.\n")
        else:
...
def show_help():
    ...
    print("3. \033[1;33mInstagram Download\033[0m: Enter '3' to download an Instagram post. Paste the URL when prompted.")
    print("4. \033[1;33mTikTok Download\033[0m: Enter '4' to download a TikTok video. Paste the URL when prompted.")
    ...
    print("If you encounter any issues, please contact the author. Thank you for using Social Media Downloader!\n")
